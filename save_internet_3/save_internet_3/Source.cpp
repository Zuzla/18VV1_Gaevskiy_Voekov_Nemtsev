...
int main()
{
	...
	for (int i = 0; i < COUNT_ITER; i++)
	{
		...
		//поняли обычный сдвиг на циклический
		UINT16 num1 = (sum >> 4) | (sum << 16 - 4); // Сдвиг вправо на четверть длины ячейки
		UINT16 num2 = (sum << 4) | (sum >> 16 - 4); // Сдвиг влево на четверть длины ячейки
